# 1. Build+Link Exercise [6 points in total]
...
## 1.1. Table of Conents

- [1. Build+Link Exercise \[6 points in total\]](#1-buildlink-exercise-6-points-in-total)
  - [1.1. Table of Conents](#11-table-of-conents)
  - [1.2. What is the exercise about](#12-what-is-the-exercise-about)
  - [1.3. Directory structure](#13-directory-structure)
  - [1.4. Exercise 1: Build by hand](#14-exercise-1-build-by-hand)
  - [1.5. Prepare your results for submission](#15-prepare-your-results-for-submission)
    - [1.5.1. Task 1: Build the `ipb_arithmetic` library \[1 points\]](#151-task-1-build-the-ipb_arithmetic-library-1-points)
    - [1.5.2. Task 2: Build the example program \[1 points\]](#152-task-2-build-the-example-program-1-points)
  - [1.6. Exercise 2: Welcome to `CMake` \[2 points\]](#16-exercise-2-welcome-to-cmake-2-points)
  - [1.7. Exercise 3: Install your library \[2 points\]](#17-exercise-3-install-your-library-2-points)
  - [1.8. Hint](#18-hint)

## 1.2. What is the exercise about
...
## 1.5. Prepare your results for submission
...
### 1.5.1. Task 1: Build the `ipb_arithmetic` library [1 points]
...
### 1.5.2. Task 2: Build the example program [1 points]
...
## 1.6. Exercise 2: Welcome to `CMake` [2 points]
...
## 1.7. Exercise 3: Install your library [2 points]
